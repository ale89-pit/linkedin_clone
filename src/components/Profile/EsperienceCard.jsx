...
const EsperienceCard = () =>{
    ...
    <CardHeader className="whiteBg fw-bold d-flex justify-content-between align-items-center">Esperienze
      <div><svg onClick={openModal} xmlns="http://www.w3.org/2000/svg" data-toggle="modal" data-target="#exampleModal" width="35" height="35" fill="currentColor" className="bi bi-plus-lg mx-2 p-1 hover" viewBox="0 0 16 16">
