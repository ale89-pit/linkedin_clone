    ...
    return (
        ...
        <Card className="my-3">
            ...
            <CardHeader className="whiteBg fw-bold d-flex justify-content-between align-items-center">Esperienze
                <div><svg onClick={openModal} xmlns="http://www.w3.org/2000/svg" data-toggle="modal" data-target="#PostExpModal" width="35" height="35" fill="currentColor" className="bi bi-plus-lg mx-2 p-1 hover" viewBox="0 0 16 16">
            ...
            <Row>
                <Col xs={2} className="d-flex justify-content-center align-items-center"><img src="https://placekitten.com/100" style={{ width: "50px" }} alt="" />
                </Col>
                <Col> <Card.Body>
